...
#   4. Installs the cron job to run daily at 6:50 AM
...
# The cron entry: run daily at 6:50 AM (10 min before 7 AM booking opens)
CRON_CMD="50 6 * * * $SCRIPT_DIR/run_booking.sh"
...
echo "=== Setup Complete ==="
echo ""
echo "Cron schedule: Daily at 6:50 AM"
